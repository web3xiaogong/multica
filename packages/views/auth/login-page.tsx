...
export function LoginPage({
  ...
  const t = useViewTranslations("auth.login");
  ...
  const handleVerify = useCallback(
    async (value: string) => {
      ...
      try {
        ...
        setError(
          err instanceof Error ? err.message : t("errors.invalidCode"),
        );
        setCode("");
        setLoading(false);
      }
  ...
  const handleResend = async () => {
    ...
    try {
      ...
      setError(
        err instanceof Error ? err.message : t("errors.resendFailed"),
      );
    }
  };
  ...
  const handleCliAuthorize = async () => {
    ...
    try {
      ...
      setError(t("errors.cliAuthorizeFailed"));
        ...
        <Card className="w-full max-w-sm">
          ...
          <CardContent className="flex flex-col items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              >
                {cooldown > 0
                  ? t("code.resendIn", { seconds: cooldown })
                  : t("code.resend")}
              </button>
            </div>
          </CardContent>
    ...
    <div className="flex min-h-svh items-center justify-center">
      <Card className="w-full max-w-sm">
        ...
        <CardFooter className="flex flex-col gap-3">
          ...
          >
            {loading ? t("form.sending") : t("form.continue")}
          </Button>
            ...
            <>
              <div className="relative w-full">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-card px-2 text-muted-foreground">{t("form.or")}</span>
                </div>
              </div>
              <Button
                type="button"
