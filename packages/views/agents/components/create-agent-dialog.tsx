...
export function CreateAgentDialog({
  ...
  const t = useViewTranslations("agents.create");
    ...
    <Dialog open onOpenChange={(v) => { if (!v) onClose(); }}>
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4 min-w-0">
          ...
          <div>
            <Label className="text-xs text-muted-foreground">{t("visibilityLabel")}</Label>
            <div className="mt-1.5 flex gap-2">
              ...
              >
                ...
                <div className="text-left">
                  <div className="font-medium">{t("visibility.workspaceTitle")}</div>
                  <div className="text-xs text-muted-foreground">{t("visibility.workspaceDescription")}</div>
                </div>
              </button>
              <button
                type="button"
              ...
              >
                ...
                <div className="text-left">
                  <div className="font-medium">{t("visibility.privateTitle")}</div>
                  <div className="text-xs text-muted-foreground">{t("visibility.privateDescription")}</div>
                </div>
              </button>
            </div>
          </div>
          ...
          <div className="min-w-0">
            <div className="flex items-center justify-between">
              <Label className="text-xs text-muted-foreground">{t("runtimeLabel")}</Label>
              {hasOtherRuntimes && (
