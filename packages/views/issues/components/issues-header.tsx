...
function ActorSubContent({
  ...
  const t = useViewTranslations("issues.header");
    ...
    <>
      ...
      <div className="max-h-64 overflow-y-auto p-1">
        ...
        {filteredMembers.length > 0 && (
          <DropdownMenuGroup>
            <DropdownMenuLabel>{t("filter.members")}</DropdownMenuLabel>
        ...
        {filteredAgents.length > 0 && (
          <DropdownMenuGroup>
            <DropdownMenuLabel>{t("filter.agents")}</DropdownMenuLabel>
...
export function IssuesHeader({ scopedIssues }: { scopedIssues: Issue[] }) {
  ...
  const scopes: { value: IssuesScope; label: string; description: string }[] = [
    { value: "all", label: t("scope.all.label"), description: t("scope.all.description") },
    { value: "members", label: t("scope.members.label"), description: t("scope.members.description") },
    { value: "agents", label: t("scope.agents.label"), description: t("scope.agents.description") },
  ];
      ...
      <div className="flex items-center gap-1">
        ...
        <DropdownMenu>
          <Tooltip>
            ...
            />
            <TooltipContent side="bottom">{t("filter.tooltip")}</TooltipContent>
          </Tooltip>
          <DropdownMenuContent align="end" className="w-auto">
            ...
            <DropdownMenuSub>
              <DropdownMenuSubTrigger>
                ...
                <span className="flex-1">{t("filter.priority")}</span>
            ...
            <DropdownMenuSub>
              <DropdownMenuSubTrigger>
                ...
                <span className="flex-1">{t("filter.assignee")}</span>
            ...
            <DropdownMenuSub>
              <DropdownMenuSubTrigger>
                ...
                <span className="flex-1">{t("filter.creator")}</span>
            ...
            <DropdownMenuSub>
              <DropdownMenuSubTrigger>
                ...
                <span className="flex-1">{t("filter.project")}</span>
            ...
            <div className="border-b px-3 py-2.5">
              ...
              <div className="mt-2 flex items-center gap-1.5">
                ...
                <Button
                  ...
                  title={sortDirection === "asc" ? t("display.ascending") : t("display.descending")}
                >
                  {sortDirection === "asc" ? (
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-auto">
            <DropdownMenuGroup>
              <DropdownMenuLabel>{t("display.viewLabel")}</DropdownMenuLabel>
