...
function SortablePinItem({ pin, href, pathname, onUnpin }: { pin: PinnedItem; href: string; pathname: string; onUnpin: () => void }) {
  const t = useViewTranslations("sidebar");
  ...
  return (
      <Sidebar variant="inset">
                      ...
                      <DropdownMenuGroup>
                        ...
                        {myInvitations.map((inv) => (
                          <div key={inv.id} className="flex items-center gap-2 px-2 py-1.5">
                            ...
                            <span className="flex-1 truncate text-sm">{inv.workspace_name ?? t("workspaceFallback")}</span>
                            <button
                              type="button"
        ...
        <SidebarContent>
          ...
          <SidebarGroup>
            <SidebarGroupLabel>{t("workspaceGroup")}</SidebarGroupLabel>
            <SidebarGroupContent>
              <SidebarMenu className="gap-0.5">
          ...
          <SidebarGroup>
            <SidebarGroupLabel>{t("configureGroup")}</SidebarGroupLabel>
            <SidebarGroupContent>
              <SidebarMenu className="gap-0.5">
